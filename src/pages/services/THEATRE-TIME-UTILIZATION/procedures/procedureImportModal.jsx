...
const ProcedureImportModal = ({ meta, importMutation, downloadTemplateQuery, onSuccess, onClose }) => {
    ...
    const handleSubmit = async (values, { setSubmitting, resetForm }) => {
        ...
        try {
            ...
            const importedCount = result?.data?.items?.length || 0;
            showToast(
        ...
        >
            {({ isSubmitting, values, setFieldValue, resetForm }) => (
                <GraphqlModal
                    ...
                    subtitle={`Upload an Excel file to bulk import ${meta.title.toLowerCase()}.`}
                    icon={<Upload size={20} />}
                    onClose={onClose}
