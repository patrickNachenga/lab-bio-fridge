...
const IDENTIFIER_TYPES = [
  ...
  { value: "INSURANCE", label: "INSURANCE", description: "Insurance Number" },
];
...
export const ReferralsListPage = () => {
  ...
  const handleSearch = async (values, { setSubmitting }) => {
    ...
    try {
      const result = await searchReferrals(
  ...
  const handleViewDetails = (patient) => {
    ...
    const patientId =
      patient.demographicDetails?.id || patient.mrn || "unknown";
    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(16, 79, 143, 1), rgba(229, 56, 53, 0.81),rgba(25, 118, 210, 0.8), rgba(12, 82, 153, 1))",
            borderBottom: "none",
          }}
        >
          <div className="d-flex align-items-center">
            ...
            <div>
              ...
              >
                <i className="bx bx-hash me-1"></i>Facility Code:{" "}
                {facility.code}
              </div>
            </div>
          </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <span className="text-muted">
                      <i
                        className={`bx ${getGenderIcon(demo.gender)} me-1`}
                      ></i>
                      {demo.gender || "-"}
                    </span>
                    <span className="text-muted">
                  ...
                  <div className="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <span
                      ...
                      style={{
                        fontSize: "10px",
                        backgroundColor:
                          diagnoses[0].certainty === "confirmed"
                            ? "#10b981"
                            : "#6b7280",
                        color: "white",
                      }}
            ...
            <div className="col-lg-2 col-md-12 col-6 text-lg-end">
              <button
                ...
                style={{
                  fontSize: "12px",
                  background:
                    "linear-gradient(135deg, rgb(25, 118, 210), rgb(229, 57, 53))",
                  color: "white",
                  border: "none",
                }}
              >
              ...
              >
                <span
                  ...
                  style={{
                    ...
                    boxShadow:
                      "0 0 8px #22c55e, 0 0 16px #22c55e, 0 0 24px #22c55e",
        ...
        <div className="card-body py-4" style={{ backgroundColor: "#f8fafc" }}>
          ...
          >
            {({ isSubmitting, values, setFieldValue }) => (
              <Form>
                <div
                  className="bg-gradient px-4 py-3 rounded-3 shadow-sm"
                  style={{
                    background:
                ...
                >
                      ...
                      >
                        {IDENTIFIER_TYPES.map((type) => (
                          <button
                            ...
                            type="button"
                            onClick={() =>
                              setFieldValue("identifier_type", type.value)
                            }
                            className={`btn ${
                              values.identifier_type === type.value
                      ...
                      >
                        ...
                        >
                          ...
                          <Field
                            ...
                            placeholder={`Enter ${
                              IDENTIFIER_TYPES.find(
                                (t) => t.value === values.identifier_type
                  ...
                  <div className="d-flex justify-content-between align-items-center mt-3 pt-2 border-top border-light">
                    <small className="text-muted">
                      ...
                      Press{" "}
                      <kbd className="bg-purple border mx-1 px-2 py-1 rounded">
                        Enter
                      </kbd>{" "}
                      to quick search
                    </small>
            ...
            <div className="text-center py-5">
              ...
              >
                <i
                  ...
                  style={{ fontSize: "30px", color: "#d97706" }}
                ></i>
              </div>
              <h6 className="fw-semibold text-dark">No Records Found</h6>
              <p className="text-muted small mb-3">
                No patient matches <code>{searchInfo?.value}</code> in{" "}
                {searchInfo?.type}
              </p>
              <button
            ...
            <div className="text-center py-5">
              <div
                ...
                style={{
                  ...
                  height: "80px",
                  background:
                    "linear-gradient(135deg, rgba(25, 118, 210, 0.1), rgba(229, 57, 53, 0.1))",
                }}
              >
                <i
              ...
              >
                Enter a patient identifier to retrieve their referral
                information from the Wizara Health Information System.
              </p>
