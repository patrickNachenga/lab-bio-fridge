...
export const ReferralDetailsPage = () => {
    ...
    const clinicalNote = clinical.visitNotes || [];
          ...
          >
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div className="d-flex align-items-center gap-3 small">
                <span>
                  <i className="bx bx-calendar text-muted me-1"></i>Visit:{" "}
                  <strong>
                    {visit.visitDate
                ...
                <span>
                  <i className="bx bx-hash text-muted me-1"></i>Visit ID:{" "}
          ...
          <div className="card-body p-4">
            <div className="row align-items-center">
              <div className="col-auto">
                ...
                >
                  {demo.firstName?.charAt(0)}
                  {demo.lastName?.charAt(0)}
                </div>
              </div>
              <div className="col">
                ...
                <div className="d-flex flex-wrap gap-3 text-muted">
                  ...
                  <span>
                    ...
                    {calculateAge(demo.dateOfBirth)} years
                  </span>
                  <span>
                    <i className="bx bx-cake me-1"></i>
                    {demo.dateOfBirth
                      ? formatDate(demo.dateOfBirth, "DD MMM YYYY")
                      : "-"}
                  </span>
                  <span>
              ...
              {tabs.map((tab) => (
                <button
                  ...
                  className={`nav-link rounded-pill px-3 py-2 ${
                    activeTab === tab.id ? "active" : "text-muted"
                  }`}
          ...
          <div className="card-body p-4">
            ...
            {activeTab === "overview" && (
              <div className="animate__animated animate__fadeIn animate__faster">
                ...
                {vitalSigns.length > 0 && (
                  <div className="mb-4">
                    <h6 className="fw-bold mb-3 text-uppercase text-muted small">
                      ...
                      <span className="fw-normal ms-2 text-primary">
                        ({vitalSigns[0].dateTime})
                      </span>
                    </h6>
                      ...
                      {[
                        {
                          ...
                          value: vitalSigns[0].bloodPressure,
                          unit: "mmHg",
                          icon: "bx-heart",
                          bg: "#fef2f2",
                        },
                        {
                          label: "Temperature",
                          value: vitalSigns[0].temperature,
                          unit: "°C",
                          icon: "bx-sun",
                          bg: "#fffbeb",
                        },
                        {
                          label: "Weight",
                          value: getVitalValue(vitalSigns[0], "weight"),
                          unit: "kg",
                          icon: "bx-body",
                          bg: "#eff6ff",
                        },
                        {
                          label: "Height",
                          value: getVitalValue(vitalSigns[0], "height"),
                          unit: "cm",
                          icon: "bx-ruler",
                          bg: "#f0fdf4",
                        },
                        ...
                        {
                          label: "Respiration",
                          value: vitalSigns[0].respiration,
                          unit: "/min",
                          icon: "bx-wind",
                          bg: "#f8fafc",
                        },
                ...
                <div className="row g-4">
                  {visitNotes.length > 0 &&
                    visitNotes[0].chiefComplains?.length > 0 && (
                      <div className="col-md-6">
                        <h6 className="fw-bold mb-3 text-uppercase text-muted small">
                          <i className="bx bx-message-error me-1"></i>Chief
                          Complaints
                        </h6>
                          ...
                          <ul className="list-unstyled mb-0">
                            {visitNotes[0].chiefComplains.map((c, idx) => (
                              <li key={idx} className="mb-2">
                                <i className="bx bx-chevron-right text-danger me-1"></i>
                                {c}
                              </li>
                            ))}
                          </ul>
                          ...
                          >
                            ...
                            <div>
                              ...
                              <small className="text-muted d-block">
                                {formatDate(d.diagnosisDate, "DD MMM YYYY")}
                              </small>
                            </div>
                          </div>
                        ))}
                ...
                <div className="mt-4">
                  ...
                  <div className="d-flex gap-3">
                    <span
                      className={`badge ${
                        lifestyle.smoking?.use ? "bg-danger" : "bg-success"
                      } px-3 py-2`}
                    >
                      <i className="bx bx-cigarette me-1"></i>Smoking:{" "}
                      {lifestyle.smoking?.use ? "Yes" : "No"}
                    </span>
                    <span
                      className={`badge ${
                        lifestyle.alcoholUse?.use ? "bg-danger" : "bg-success"
                      } px-3 py-2`}
                    >
                      <i className="bx bx-wine me-1"></i>Alcohol:{" "}
                      {lifestyle.alcoholUse?.use ? "Yes" : "No"}
                    </span>
                    <span
                      className={`badge ${
                        lifestyle.drugUse?.use ? "bg-danger" : "bg-success"
                      } px-3 py-2`}
                    >
                      <i className="bx bx-injection me-1"></i>Drug Use:{" "}
                      {lifestyle.drugUse?.use ? "Yes" : "No"}
                    </span>
                  </div>
                </div>
              </div>
                    ...
                    <table className="table table-sm">
                      <tbody>
                        {[
                          [
                            "Full Name",
                            `${demo.firstName} ${demo.middleName || ""} ${
                              demo.lastName
                            }`,
                          ],
                          [
                      ...
                      <div className="bg-light rounded-3 p-3 mt-3">
                        <div className="d-flex align-items-center mb-2">
                          <span className="badge bg-primary me-2">
                            {addresses[0].category}
                          </span>
                          <small className="text-muted">Address</small>
                        </div>
                        <p className="mb-0">
                          {addresses[0].village}, {addresses[0].ward}
                          <br />
                          {addresses[0].district}, {addresses[0].region}
                          <br />
                          {addresses[0].country}
                        </p>
                      </div>
            ...
            {activeTab === "clinical" && (
              <div className="animate__animated animate__fadeIn animate__faster">
                ...
                {/* Visit Notes - Clinical Timeline View */}
                {/* Clinical Notes - Modern Hospital Dashboard */}
                {/* Simple Visit Notes Section */}
                <div className="mb-4">
                  {/* Section Header */}
                  <div className="d-flex align-items-center justify-content-between mb-3">
                    <div>
                      <h5 className="fw-bold text-dark mb-1">
                        <i className="bx bx-clipboard text-primary me-2"></i>
                        Visit Notes
                      </h5>
                    ...
                    <span className="badge bg-light text-dark border">
                      {clinicalNote.length}{" "}
                      {clinicalNote.length === 1 ? "Visit" : "Visits"}
                    </span>
                  </div>

                  {clinicalNote.length > 0 ? (
                    <div className="row g-3">
                      {clinicalNote.map((note, idx) => {
                              ...
                              <div className="card-body p-4">
                                ...
                                <div className="d-flex justify-content-between align-items-start mb-3">
                                    ...
                                    <div className="d-flex align-items-center gap-2">
                                      ...
                                      {note.injured && (
                                        <span className="badge bg-danger">
                                          <i className="bx bx-injury me-1"></i>
                                          Injury
                                        </span>
                                      )}
                                    </div>
                                  ...
                                  <span className="badge bg-info bg-opacity-10 text-info">
                                    <i className="bx bx-user-md me-1"></i>
                                    {note.providerSpeciality || "Doctor"}
                                  </span>
                                </div>

                                {/* Clinical Content - Only from payload */}
                                <div className="row g-3">
                                  {/* Chief Complaints */}
                                  {note.chiefComplains?.length > 0 && (
                                    <div className="col-12">
                                      <div className="border-start border-danger border-3 ps-3 py-2">
                                        <div className="d-flex align-items-center mb-1">
                                          <i className="bx bx-message-alt-error text-danger me-2"></i>
                                          <strong className="text-danger">
                                            Chief Complaints
                                          </strong>
                                        </div>
                                        <div className="ms-4">
                                          {note.chiefComplains.map(
                                            (complaint, i) => (
                                              <div
                                                key={i}
                                                className="small d-flex align-items-start mb-1"
                                              >
                                                <i className="bx bx-minus text-danger mt-1 me-2"></i>
                                                <span>{complaint}</span>
                                              </div>
                                            )
                                          )}
                                  ...
                                  {note.historyOfPresentIllness?.length > 0 && (
                                    <div className="col-md-6">
                                      <div className="border-start border-info border-3 ps-3 py-2">
                                        <div className="d-flex align-items-center mb-1">
                                        ...
                                        <div className="ms-4">
                                          {note.historyOfPresentIllness.map(
                                            (item, i) => (
                                              <div
                                                key={i}
                                                className="small d-flex align-items-start mb-1"
                                              >
                                                <i className="bx bx-chevron-right text-info mt-1 me-2"></i>
                                                <span>{item}</span>
                                              </div>
                                            )
                                          )}
                                  ...
                                  {/* Review of Systems */}
                                  {note.reviewOfOtherSystems?.length > 0 && (
                                    <div className="col-md-6">
                                      <div className="border-start border-purple border-3 ps-3 py-2">
                                        <div className="d-flex align-items-center mb-1">
                                          <i className="bx bx-body text-purple me-2"></i>
                                          <strong className="text-purple">
                                            Review of Systems
                                          </strong>
                                        </div>
                                        <div className="ms-4">
                                          {note.reviewOfOtherSystems.map(
                                            (system, i) => (
                                              <div
                                                key={i}
                                  ...
                                  {/* Examinations */}
                                  {(note.generalExaminationObservation?.length >
                                    0 ||
                                    note.localExamination?.length > 0 ||
                                    note.systemicExaminationObservation
                                      ?.length > 0) && (
                                    <div className="col-12">
                                      <div className="border-start border-primary border-3 ps-3 py-2">
                                        <div className="d-flex align-items-center mb-1">
                                          <i className="bx bx-analyse text-primary me-2"></i>
                                            ...
                                            {note.generalExaminationObservation
                                              ...
                                              <div className="col-md-4">
                                                <div className="small">
                                                  ...
                                                  {note.generalExaminationObservation.map(
                                                    (item, i) => (
                                                      <div
                                                        key={i}
                                                        className="d-flex align-items-start"
                                                      >
                                                        <i className="bx bx-check text-success mt-1 me-2"></i>
                                                        <span>{item}</span>
                                                      </div>
                                                    )
                                                  )}
                                            ...
                                            {note.systemicExaminationObservation
                                              ...
                                              <div className="col-md-4">
                                                <div className="small">
                                                  ...
                                                  {note.systemicExaminationObservation.map(
                                                    (item, i) => (
                                                      <div
                                                        key={i}
                                                        className="d-flex align-items-start"
                                  ...
                                  {note.familyAndSocialHistory?.length > 0 && (
                                    <div className="col-6">
                                      <div className="border-start border-success border-3 ps-3 py-2">
                                        <div className="d-flex align-items-center mb-1">
                                          <i className="bx bx-group text-success me-2"></i>
                                        ...
                                        <div className="ms-4">
                                          <div className="row g-2">
                                            {note.familyAndSocialHistory.map(
                                              (item, i) => (
                                                <div
                                                  className="col-md-6"
                                                  key={i}
                                                >
                                                  <div className="small d-flex align-items-start">
                                                    <i className="bx bx-user text-success mt-1 me-2"></i>
                                                    <span>{item}</span>
                                                  </div>
                                                </div>
                                              )
                                  ...
                                  {/* Doctor Plan Or Suggestion */}
                                  {note.doctorPlanOrSuggestion?.length > 0 && (
                                    <div className="col-6">
                                      <div className="border-start border-success border-3 ps-3 py-2">
                                        <div className="d-flex align-items-center mb-1">
                                          <i className="bx bx-user text-warning me-2"></i>
                                          <strong className="text-warning">
                                            Doctor Plan / Suggestion
                                          </strong>
                                        </div>
                                        <div className="ms-4">
                                          <div className="row g-2">
                                            {note.doctorPlanOrSuggestion.map(
                                              (item, i) => (
                                                <div
                                                  className="col-md-6"
                                                  key={i}
                                                >
                                                  <div className="small d-flex align-items-start">
                                                    <i className="bx bx-list text-warning mt-1 me-2"></i>
                                                    <span>{item}</span>
                                                  </div>
                                                </div>
                                              )
                                  ...
                                  {/* Empty State for this visit */}
                                  {!note.chiefComplaints?.length &&
                                    !note.historyOfPresentIllness?.length &&
                                    !note.reviewOfOtherSystems?.length &&
                                    !note.generalExaminationObservation
                                      ?.length &&
                                    !note.localExamination?.length &&
                                    !note.systemicExaminationObservation
                                      ?.length &&
                                    !note.familyAndSocialHistory?.length && (
                                      <div className="col-12">
                                        <div className="text-center py-3 border rounded-3 bg-light">
                                          <i className="bx bx-note text-muted mb-2"></i>
                                          <p className="text-muted small mb-0">
                                            No clinical details recorded for
                                            this visit
                                          </p>
                                        </div>
                                      </div>
                    ...
                    <div className="card border-0 shadow-sm">
                      <div className="card-body text-center py-4">
                        <i
                          className="bx bx-clipboard text-muted mb-3"
                          style={{ fontSize: "2rem" }}
                        ></i>
                        ...
                        <p className="text-muted small mb-0">
                          Patient has no recorded visit history
                        </p>
                      </div>
                    </div>
                  )}
                          ...
                          <tr key={idx}>
                            ...
                            <td>
                              ...
                              {d.diagnosisDescription &&
                                d.diagnosisDescription !== d.diagnosis && (
                                  <small className="text-muted d-block">
                                    {d.diagnosisDescription}
                                  </small>
                                )}
                      ...
                      <div className="col-md-6" key={idx}>
                        <div className="border rounded-3 p-3 h-100">
                          ...
                          <div className="small text-muted">
                            <div>
                              <i className="bx bx-calendar me-1"></i>Ordered:{" "}
                              {formatDate(m.orderDate, "DD MMM YYYY")}
                            </div>
                            <div>
                              <i className="bx bx-time me-1"></i>Duration:{" "}
                              {m.periodOfMedication}
                            </div>
                            {m.dosage && (
                              <>
                                <div>
                                  <i className="bx bx-droplet me-1"></i>Dose:{" "}
                                  {m.dosage.dose}
                                </div>
                                <div>
                                ...
                                <div>
                                  ...
                                  Frequency: {m.dosage.frequency}x daily
                                </div>
                              </>
                            )}
                          </div>
            ...
            {activeTab === "investigations" && (
              <div className="animate__animated animate__fadeIn animate__faster">
                <div className="row g-4">
                  <div className="col-12">
                    <h6 className="fw-bold mb-3 text-uppercase text-muted small border-bottom pb-2">
                      <i className="bx bx-test-tube me-1"></i>Laboratory
                      Investigations
                    </h6>
                        ...
                        <table className="table table-hover table-sm">
                          ...
                          <tbody>
                            {investigations.map((inv, idx) => (
                              <tr key={idx}>
                                <td>
                                  {formatDate(inv.dateOccurred, "DD MMM YYYY")}
                                </td>
                                <td>
                            ...
                            <div className="border rounded p-3">
                              <div className="d-flex justify-content-between">
                                ...
                                <small className="text-muted">
                                  {formatDate(r.testDate, "DD MMM YYYY")}
                                </small>
                              </div>
                              {r.url && (
                                <a
                      ...
                      <table className="table table-sm table-borderless mb-0">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <code>{payment.insuranceCode || "-"}</code>
                            </td>
                          </tr>
                          <tr>
                            <td className="text-muted">Member ID</td>
                            <td>
                              <code>{payment.insuranceId || "-"}</code>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    {billings.length > 0 ? (
                      <>
                        <div className="alert alert-success py-2 d-flex justify-content-between align-items-center">
                          <span>
                            <i className="bx bx-money me-1"></i>Total Amount
                            Billed
                          </span>
                          ...
                          <table className="table table-sm table-hover">
                            ...
                            <tbody>
                              {billings.map((b, idx) => (
                                <tr key={idx}>
                                  <td>
                                    <code>{b.billingCode}</code>
                                  </td>
                                  <td>{b.billType}</td>
                                  <td className="text-end fw-semibold">
                                    TZS {b.amountBilled?.toLocaleString()}
                                  </td>
                                </tr>
                              ))}
                            </tbody>
